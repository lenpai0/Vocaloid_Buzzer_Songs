...
/*
  ...
  yowamushi montblanc short buzzer cover

  弱虫モンブラン (Yowamushi Montblanc) / DECO*27: https://www.youtube.com/watch?v=B-A2eYlbrwQ

  piano cover borrowed / jazzermazzer99: https://musescore.com/user/3119766/scores/3618936
...
int tempo = 120; //tempo of the song

// this calculates the duration of a whole note in ms (60s/tempo)*4 beats
int wholenote = (60000 * 4) / tempo;

int mainMelody[] = {
  AS3, DS4, REST, F4, DS4, C4, REST, C4, AS3, C4, AS3, REST, AS3, DS4, F4, DS4, C4, REST, C4, AS3, C4, AS3, REST,
  AS3, DS4, DS4, F4, DS4, C4, REST, C4, AS3, C4, AS3, REST, AS3, DS4, F4, DS4, C4, REST, AS3, DS4, D4, D4, DS4,

  DS5, DS5, C6, AS5, G5, F5, DS5, AS4, DS5, F5, G5,
  DS5, DS5, C6, AS5, G5, F5, DS5, AS4, DS5, F5
};
...
/* 1 = WHOLE NOTE    
  ...
  16 = SIXTEENTH NOTE */
int mainNotes[] = {
  8, 16, -8, 8, 8, 4, 8, 8, 4, 4, 4, 8, 8, 4, 8, 8, 4, 8, 8, 4, 4, 4, 8, 8, 8, 8, 8, 8, 4, 8,
  8, 4, 4, 4, 8, 8, 4, 8, 8, 4, 4, 4, 4, 4, 8, 8,

  -4, 8, 4, -4, 8, 8, 8, 8, 8, 8, 8, -4, 8, 4, -4, 8, 8, 8, 8, 8, 4
};
