...
/*
  ...
  cyberpunk dead boy short buzzer cover

  サイバーパンクデッドボーイ (CYBERPUNK DEAD BOY) / Maiki-P: https://www.youtube.com/watch?v=5HPJ7eUvU4o

  piano cover borrowed / twinkleplatter: https://www.youtube.com/watch?v=Ftf-4Qqs-5U
...
int tempo = 156; //tempo of the song
...
int mainMelody[] = {
  ...
  C5, G5, F5, DS5, C5, F5, F5, F5, G5, AS5, G5, F5, C5, G5, F5, DS5, C5, F5, F5, F5, F5,
  G5, AS5, G5, F5, DS5, G5, AS5, C6, C6, C6, AS5, G5, AS5, G5, F5, DS5,
  FS5, F5, DS5, C5, AS4, C5, REST, AS4, C5, C5, C5, REST, AS4, FS5, F5, C6,
  AS5, G5, AS5, C6, REST, C6, AS5, G5, DS6, D6, C6
};
...
int mainNotes[] = {
  ...
  8, 8, 8, 8, 16, 16, 16, 16, 8, 16, 16, 16, 16, 8, 4, 4,

  8, 8, 8, 8, 8, 4, 4, 8, 8, 8, 8, -4, 8, 8, 8, 8, 8, 4, 8, 8, 8, 8, 8, 8, -4,
  8, 4, 4, 4, 4, 8, 8, 8, 4, 8, 8, 4, 8, 8, 8, 8, 16, 16, 16, 16, 8, 16, 16, 16, 16,
  8, 4, 8, 8, 8, 4, 4, 8, 8, 8, 8, 4, 4, 2
};
