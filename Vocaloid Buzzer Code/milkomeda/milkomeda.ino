...
/*
  ...
  milkomeda short buzzer cover

  ミルコメダ（Milkomeda）/ marasy: https://www.youtube.com/watch?v=dJR7qnqEIuU

  transcribe by Shikito Kaishin: https://youtu.be/C8xJd3FXWqY?t=256 https://musescore.com/user/30131506/scores/21826543
...
int tempo = 175; // tempo of the song
...
int mainMelody[] = {
  ...
  //chorus
  C6, DS6, C6,  
  G5, F5, G5, F5, DS5, C5, G5, F5, G5, F5, DS5, C5, G5,
  F5, G5, F5, G5, AS5, F5, F5, DS5, D5, DS5, D4, AS4, C5,
  C5, AS4, C5, AS4, G5, F5, F5, F5, DS5, F5, AS5, G5, F5, G5,

  DS6, D6, AS5, G5, F5, G5, F5, DS5, G5, G5, F5, G5, F5, DS5, C5,
  G5, F5, G5, F5, DS5, C5, G5, F5, G5, G5,
  F5, G5, AS5, F5, G5,
  DS6, D6, AS5, G5, G5, F5, G5, AS5, G5, F5, DS5, DS5, AS4, C5,
  G5, F5, G5, F5, DS5, AS5, GS5, G5,
  G5, F5, G5, AS5, G5, F5, DS5, DS5, AS4, C5, G5, F5, G5, AS5, G5, AS5, AS5, C6
};
...
int mainNotes[] = {    
  ...
  4, 4, 8, 8, 8, 4, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8,
  
  8, 8, 8, 4, 4, 4,  //chorus
  4, 4, 4, 8, 8, 8, 8, 4, 4, 8, 8, 8, 8, 4, 4, 8, 8, 8, 8, 4, 8,
  8, 4, 16, 16, 4, 8, 8, 8, 8, 8, 4, 8, 8, 8, 8, 8, 8, 8, 4,

  4, 4, 8, 8, 8, 8, 8, 8, 4, 4, 4, 4, 8, 8, 8, 8, 4, 4, 8, 8, 8,
  8, 4, -8, 16, 8, 8, 8, 8, 4, 4, 4, 4, -4, 16, -4, 16, 8, 8, 8, 8,
  -4, 16, 4, 4, 4, 4, 4, 4, 4, 4, -4, 16, -4, 16, 8, 8, 8, 8, -4, 16,
  4, 4, 4, 4, 4, 4, 4, 4, 2
};
