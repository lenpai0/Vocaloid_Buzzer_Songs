...
/*
  ...
  senbonzakura short buzzer cover

  千本桜 (Senbonzakura) / WhiteFlame: https://www.youtube.com/watch?v=shs0rAiwsGQ

  piano cover borrowed / Piano Music Bros.: https://www.youtube.com/watch?v=OpNWT6a8n9U
...
int tempo = 154; //tempo of the song
