...
/*
  ...
  melt short buzzer cover

  メルト (Melt) / ryo: https://www.nicovideo.jp/watch/sm1715919

  piano cover borrowed / aregan - piano: https://www.youtube.com/watch?v=RQM-lJItOf8
...
int tempo = 170; //tempo of the song

// this calculates the duration of a whole note in ms (60s/tempo)*4 beats
int wholenote = (60000 * 4) / tempo;

int mainMelody[] = {
  FS4, E4, D4, D4, E4, D4, D4, FS4, E4, D4, D4, E4, A4, FS4, REST,
  FS4, E4, D4, D4, E4, D4, D4, D4, E4, F4, G4,  //, REST,

  FS4, E4, D4, D4, E4, D4, D4, FS4, E4, D4, D4, E4, A4, FS4, REST,
  FS4, E4, D4, D4, E4, D4, D4, D4, E4, F4, G4
};
...
/* 1 = WHOLE NOTE    
  ...
  16 = SIXTEENTH NOTE */
int mainNotes[] = {
  -4, 8, 4, 4, 4, 4, 2, -4, 8, 4, 4, 4, 4, -4, 8, -4, 8, 4, 4, 4, 4, 4, 8, 8, 1, 1,
  -4, 8, 4, 4, 4, 4, 2, -4, 8, 4, 4, 4, 4, -4, 8, -4, 8, 4, 4, 4, 4, 4, 8, 8, 1, 1
};
